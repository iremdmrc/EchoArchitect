...
namespace Genies.Sdk.Bootstrap.Editor
{
    ...
    internal class GeniesSdkBootstrapWizard : EditorWindow
    {
        ...
        private static void CheckAndShowWizardOnLoad()
        {
            ...
            bool showWizardOnStartup = GetUserSettingBool(ShowWizardOnStartupPrefKey, false);
            bool checkPrerequisitesOnLoad = GetUserSettingBool(CheckPrerequisitesOnLoadPrefKey, false);
            ...
            // Echo Architect uses a local fallback customizer until Genies auth/bootstrap is configured.
        }
